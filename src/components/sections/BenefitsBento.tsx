...
const features = [
  {
    ...
    description: "Sea moss delivers 92 of the 102 minerals your body needs",
    icon: Droplets,
    accent: "#C5A55A",
  },
  {
    ...
    description: "Matched to your body\u2019s natural pH for comfort",
    icon: Scale,
    accent: "#3B5EAB",
  },
  {
  ...
  },
  {
    ...
    description: "No animal products, no animal testing",
    icon: Heart,
    accent: "#C5A55A",
  },
];
...
function FeatureCard({
  ...
  return (
    ...
    >
      ...
      />
      <div className="relative bg-[#1E1E2E] rounded-2xl p-5 border border-white/10 overflow-hidden h-full">
        <motion.div
        ...
        <div className="relative z-10 flex flex-col h-full min-h-[160px]">
          ...
          >
            ...
            />
            <Icon className="w-5 h-5 relative z-10" style={{ color: feature.accent }} />
          </motion.div>
          <div className="flex-1">
            ...
            >
              <span style={{ color: feature.accent }}>{feature.stat}</span>
            </motion.div>
            <h3 className="text-sm font-semibold text-white mt-1">{feature.title}</h3>
            <p className="text-xs text-white/50 mt-1.5 leading-relaxed">{feature.description}</p>
          </div>
          <motion.div
  ...
  return (
    <section id="benefits" className="relative py-16 sm:py-24 overflow-hidden">
      ...
      <div ref={ref} className="max-w-5xl mx-auto px-6 relative z-10">
        ...
        >
          <motion.span
            className="inline-block font-mono text-[10px] tracking-[0.3em] uppercase font-semibold"
            style={{ color: "#C5A55A" }}
